...
Public Class InvestSignup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not Page.IsPostBack) Then
            If Not (Request.QueryString("message")) Is Nothing Then
                If (Request.QueryString("message") = "verified") Then
                    GlobalModule.SetMessage(messageLable, True, "Your account has been verified successfully.Please SignIn")
                End If
                ...
                If dv.Count > 0 Then
                    If dv(0)("Status") = True Then
                        ...
                        If Not Request.QueryString("name") Is Nothing Then
                            Response.Redirect(Request.QueryString("name") & "#investDiv", False)
                        Else
    ...
    Protected Sub btnSignup_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSignup.Click
        Try
            If Not Page.IsValid = False Then
                ...
                Else
                    Try
                        SendValidationEmail(txtUserName.Text, txtFirstName.Text, txtLastName.Text, txtEmail.Text, uuID, userID, Request.QueryString("name"))
    ...
    Private Sub SendValidationEmail(ByVal UserName As String, ByVal FirstName As String, ByVal LastName As String, ByVal email As String, ByVal uuid As String, ByVal UserID As Integer, ByVal boardName As String)
        Try
            ...
            Dim verificationLink As String = "<a href='" & ConfigurationManager.AppSettings("site").ToString() & "/Account/Verification.aspx?UserID=" & UserID & "&uuid=" & uuid & "&name=" & boardName & "'>Please click here to Verify your Account</a>"
    ...
    Private Sub SendMailToAdmin(ByVal userName As String, ByVal firstName As String, ByVal lastName As String, ByVal Email As String)
        Try
            ...
            If Not (Request.QueryString("from")) Is Nothing Then
                ...
                strSubject = "New User Registered referred by " & Me.userID

            Else
                strSubject = "New User Registered"
            End If
            Dim toAddress As String = ConfigurationManager.AppSettings("adminEmail").ToString()
            Dim strBody2 As String = strBody + "<br><br>User Name: " & userName & " <br>First Name: " & firstName & " <br>Last Name: " & lastName & " <br>email: " & Email
    ...
    Protected Sub signInLinkedIn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles signInLinkedIn.Click
        Try
            ...
            Session("returnURL") = Request.QueryString("name")
