...
Partial Class HomeTest
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            End If
            Try
                lbtnAdmin.Visible = checkIfAdmin()
                LoadData()
                BindNews()
    ...
    Protected Sub nonFriendDataList_ItemDataBound(ByVal sender As Object, ByVal e As DataListItemEventArgs) Handles nonFriendDataList.ItemDataBound
        Try
            ...
            Dim path As String = GM.GetImageURL(hdnFriend.Value & ".jpg", "150", "150", "Upload/ProfilePics", "Upload/ProfilePics/thumbnail")

            Dim attributeValue As String = "background-image:url(" & path & ");height:100%; width:100%; background-repeat:no-repeat; overflow: hidden;  background-size: 100% 100%;"
    ...
    Protected Sub surfBoardsRepeater_ItemDataBound(ByVal sender As Object, ByVal e As RepeaterItemEventArgs) Handles surfBoardsRepeater.ItemDataBound
        Try
            ...
            If Not isAvail("~/Upload/BoardCoverPics/" & hdnDirectoryName.Value & ".jpg").Contains("noimage.jpg") Then
                ...
                coverPicDiv.Attributes.Add("style", "background-image:url(" & pathCoverPic & ");min-height: 50px; width: 100%;background-repeat:no-repeat; background-size: 100% 100%; overflow:hidden;")
            Else
                coverPicDiv.Attributes.Add("style", "background-color:#626262;min-height: 50px; width: 100%;")
            End If
        Catch ex As Exception
            Throw ex
            GlobalModule.ErrorLogFile(ex)
    ...
    Protected Sub postRadButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles postRadButton.Click
        Try
            If txtPost.Text <> "" Then
                Dim message As String = CheckBoarName(txtPost.Text)
                ...
                GlobalModule.SetMessage(messageLabel, True, "Post added succesfully")
            Else
    ...
    Protected Sub crowdNewsDataList_ItemCommand(ByVal sender As Object, ByVal e As DataListCommandEventArgs) Handles crowdNewsDataList.ItemCommand
        Try
            ...
            If (e.CommandName = "IRecommendPost") Then
                ...
                BindAllNews()
                BindNews()
            ElseIf (e.CommandName = "IRecommendPost1") Then
    ...
    Protected Sub btnSearchDistrics_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchDistrics.Click
        Dim searchBoards = searchTextBox.Text
    ...
    'Protected Sub crowdNewFullImageButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles crowdNewFullImageButton.Click
    '    ' radMultiPageCrowdNewFull.SelectedIndex = 0
    '    BindAllNews()
    'End Sub
    ...
    End Sub
    Protected Sub lbtnAdmin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbtnAdmin.Click
