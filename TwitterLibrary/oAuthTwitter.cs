...
namespace oAuthExample
{
    public class oAuthTwitter : OAuthBase
    {
        ...
        private string _callBackUrl = ConfigurationManager.AppSettings["twitterCallbackUrl"];
        ...
        public string oAuthWebRequest1(Method method, string url, string postData)
        {
            string outUrl = "";
            string querystring = "";
            string ret = "";
